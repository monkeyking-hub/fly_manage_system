    ...
    , ui(new Ui::newHomeWindow)
{
    ...
    QPixmap scaledPixmap1 = pixmap1.scaled(ui->label_12->size(),
                                           Qt::KeepAspectRatio,
                                           Qt::SmoothTransformation);
    ui->label_12->setPixmap(scaledPixmap1);

    QPixmap pixmap2(":/newHomeWindow2.png");
    QPixmap scaledPixmap2 = pixmap2.scaled(ui->label_15->size(),
                                           Qt::KeepAspectRatio,
                                           Qt::SmoothTransformation);
    ui->label_15->setPixmap(scaledPixmap2);

    QPixmap pixmap3(":/newHomeWindow3.png");
    QPixmap scaledPixmap3 = pixmap3.scaled(ui->label_11->size(),
                                           Qt::KeepAspectRatio,
                                           Qt::SmoothTransformation);
    ui->label_11->setPixmap(scaledPixmap3);

    QPixmap pixmap4(":/newHomeWindow4.png");
    QPixmap scaledPixmap4 = pixmap4.scaled(ui->label_5->size(),
                                           Qt::KeepAspectRatio,
                                           Qt::SmoothTransformation);
    ...
    connect(UserManager::getInstance(),
            ...
            this,
            [lbl](const User &User) { lbl->setText(User.username); });
    connect(ui->commandLinkButton_3,
            &QCommandLinkButton::clicked,
            this,
            &newHomeWindow::onCommandLinkeButton3Clicked);
    connect(ui->commandLinkButton_4,
            &QCommandLinkButton::clicked,
            this,
            &newHomeWindow::commandLinkButton4Clicked);
    connect(ui->commandLinkButton_5,
            &QCommandLinkButton::clicked,
            this,
            &newHomeWindow::commandLinkButton5Clicked);
    connect(ui->commandLinkButton_6,
            &QCommandLinkButton::clicked,
            this,
            &newHomeWindow::commandLinkButton6Clicked);
}
