    ...
    , ui(new Ui::maininterface)
{
    ...
    kefuLabel->setStyleSheet("font-size: 20px; color: black; font-family: '千图笔锋手写体';");
    ...
    connect(switchFlightStatusWindowAction,
            &QAction::triggered,
            this,
            &maininterface::switchtoFlightStatusWindow);
}
