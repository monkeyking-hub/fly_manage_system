...
Order::Order()
    ...
    , m_departureAirport("")
    , m_firstClassSeats(0)
    , m_economyClassSeats(0)
    , m_businessClassSeats(0)
    , m_firstClassPrice(0.0)
    , m_economyClassPrice(0.0)
    , m_businessClassPrice(0.0)
{}

// 带参数的构造函数
Order::Order(const QString &orderNumber,
